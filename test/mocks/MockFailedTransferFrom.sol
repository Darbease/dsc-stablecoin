 ...
 * @notice ERC20-like token whose `transferFrom` always returns false. Used to exercise
 * DSCEngine's `if (!success) revert DSCEngine__TransferFailed()` branch on deposit.
 */
